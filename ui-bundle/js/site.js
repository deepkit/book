!function () {
    "use strict";
    var e, o, r, v = /^sect(\d)$/, i = document.querySelector(".nav-container"),
        a = document.querySelector(".nav-toggle"), c = i.querySelector(".nav"),
    ...
    function h(e, t) {
        if (!t) return;
        var n = e.getBoundingClientRect(), i = n.height, a = window.getComputedStyle(c);
    ...
    s && (e = i.querySelector("[data-panel=explore]"), o = s.querySelector(".is-current-page"), (r = o) ? (p(o), h(s, o.querySelector(".nav-link"))) : s.scrollTop = 0, u(s, ".nav-item-toggle").forEach(function (e) {
        var t = e.parentElement, e = (e.addEventListener("click", n.bind(t)), function (e, t) {
...
!function () {
    ...
    if (e) {
        ...
        if (!(l < 0)) {
            ...
            var a = {}, s = c.reduce(function (e, t) {
                ...
                }, document.createElement("ul")), i = e.querySelector(".toc-menu"),
    ...
    function p() {
        var n, i, t, e = window.pageYOffset, o = 1.15 * h(document.documentElement, "fontSize"),
            r = f.offsetTop;
...
!function () {
    ...
    function r(e) {
        ...
        // }(this, 0);
        // console.log('r', this, t.offsetParent, x, t.getBoundingClientRect().bottom);
        // window.scrollTo(0, x - t.getBoundingClientRect().bottom)
    }
...
!function () {
    "use strict";
    var o = /^\$ (\S[^\\\n]*(\\\n(?!\$ )[^\\\n]*)*)(?=\n|$)/gm, s = /( ) *\\\n *|\\\n( ?) */g,
        l = / +$/gm, d = (document.getElementById("site-script") || {dataset: {}}).dataset;
    [].slice.call(document.querySelectorAll(".doc pre.highlight, .doc .literalblock pre")).forEach(function (e) {
        var t, n, c, i;
        if (e.classList.contains("highlight")) (a = (t = e.querySelector("code")).dataset.lang) && "console" !== a && ((c = document.createElement("span")).className = "source-lang", c.appendChild(document.createTextNode(a))); else {
